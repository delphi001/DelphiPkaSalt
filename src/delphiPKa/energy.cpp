...
void CEnergy::run() {
    ...
    param->initscale = initscale;
    param->focus2initscaleratio     = focus2initscaleratio;
    param->indi      = indi;
    param->exdi      = exdi;
    param->prbrad    = prbrad;
    param->ionrad    = ionrad;
    ...
    if (id == 0) {
        ...
        for (i = 0; i < vecIonRes.size(); i++) {
            ...
            if (resnam == "GLU" || resnam == "ASP" || resnam == "TYR" || resnam == "THR" || resnam == "SER" || resnam == "CYS") sign = "-";
        ...
        for (i = 0; i < vecIonRes.size(); i++) {
            for (j = 0; j < vecIonRes.size(); j++) {
                ...
                if (resnam == "GLU" || resnam == "ASP" || resnam == "TYR" || resnam == "THR" || resnam == "SER" || resnam == "CYS")
                    sign = "-";
